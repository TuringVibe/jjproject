<nav class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        @endif
        <li class="nav-item"><a class="nav-link {{$active == "projects.list" ? "active" : ""}}" href="{{route('projects.list')}}"><i class="fas fa-th-list"></i> <span class="menu-title">Project List</span></a></li>
